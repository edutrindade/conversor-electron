...
const App: React.FC = () => {
    ...
    useEffect(() => {
        const handleExportProgress = (_event: any, { current, total, progress }: { current: number; total: number; progress: number }) => {
            setCurrent(current);
            setTotal(total);
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type='text' id='db_path' value={dbPath} onChange={(e) => setDbPath(e.target.value)} placeholder='/caminho/para/seubanco.fb' required />
